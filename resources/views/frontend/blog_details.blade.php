                                    ...
                                    @foreach ($allblog as $value)
                                        <li class="rc__post__item">
                                            <div class="rc__post__thumb">
                                                <a href="blog-details.html"><img src="{{ asset($value->blog_image) }}" alt=""></a>
                                            </div>
                                            <div class="rc__post__content">
                                                <h5 class="title"><a href="#">{{ $value->blog_title }}</a></h5>
                            ...
                            <div class="widget">
                                ...
                                <ul class="sidebar__cat">
                                    @foreach ($blog_category as $cat)
                                        <li class="sidebar__cat__item"><a href="{{ route('category.blog', $cat->id) }}">{{ $cat->blog_category }} (6)</a></li>
                                    @endforeach
