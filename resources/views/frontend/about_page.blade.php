                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="about__education__item">
                                                <h3 class="title">
                                                    Moat Academy for Developers</h3>
                                                <span class="date">Aug 2022 – Oct 2022</span>
                                                <p>
                                                    <ul class="services__list">
                                                        <li>Learnt the fundamentals of PHP, including its syntax, functions, and features, as well as experience working with PHP frameworks, libraries, and tools,</li>
                                                        <li>Offers intensive, hands-on courses that cover the fundamentals of web development, including languages such as HTML, CSS, and JavaScript, 
                                                        as well as frameworks such as Laravel,</li>
                                                        <li>Experience with databases such as MySQL,</li> 
                                                        <li>Strong problem-solving and debugging skills,</li> 
                                                        <li>Good communication and collaboration skills,</li>
                                                        <li>Applying your skills and knowledge to real-world projects.</li>
                                                    </ul>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="about__education__item">
                                                <h3 class="title">
                                                    University of Nigeria, Nsukka</h3>
                                                <span class="date">Nov 2014 – Aug 2018</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                ...
                                <div class="services__style__two__content">
                                    <h3 class="title"><a href="services-details.html">{{ $serve->title }}</a></h3>
                                    <p>{!! Str::limit($serve->short_description, 70,) !!}</p>
                                    <a href="{{ route('service.details', $serve->id) }}" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
