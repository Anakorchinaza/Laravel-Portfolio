                    ...
                    <div class="card-body">
                       ...
                       <form action="{{ route('update.blog') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_title" class="form-control" type="text" value="{{ $editblog->blog_title }}" id="example-text-input">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_tags" class="form-control" type="text" value="{{ $editblog->blog_tags }}" data-role="tagsinput">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                   <input type="submit" name="" class="btn btn-info waves-effect waves-light" value="Update Blog">
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
