                                    ...
                                    <div class="col-12">
                                        {{-- <input class="form-control" id="username" name="username" type="text" required="" placeholder="Username">
                                         <x-input-error :messages="$errors->get('username')" class="mt-2" /> --}}
                                            ...
                                            <x-text-input id="username" class="block mt-1 w-full"  class="form-control" type="text" name="username" :value="old('username')" required autofocus />
                                            <x-input-error :messages="$errors->get('username')" class="mt-2" />
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox">
                                            {{-- <input type="checkbox" id="remember_me" name="remember" class="custom-control-input" id="customCheck1">
